...
library(data.table)  
library(h2o)
setwd("D:\\KaggleProjectsAndData\\rossmann-store-sales\\Data")
cat("reading the train and test data (with data.table) \n")
train <- fread("D:\\KaggleProjectsAndData\\rossmann-store-sales\\Data\\train.csv",stringsAsFactors = T)
test  <- fread("D:\\KaggleProjectsAndData\\rossmann-store-sales\\Data\\test.csv",stringsAsFactors = T)
store <- fread("D:\\KaggleProjectsAndData\\rossmann-store-sales\\Data\\store.csv",stringsAsFactors = T)
